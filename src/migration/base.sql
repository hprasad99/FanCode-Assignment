...
insert ignore into mydb.news (title, description, matchId, tourId)
values
    ('Exciting Match Ahead!', 'Don''t miss out on the upcoming match between Team A and Team B. It promises to be a thrilling encounter.', 1, 1),
    ('New Sponsor Announcement', 'We are thrilled to announce our partnership with XYZ Corporation for the upcoming tournament.', 2, 1),
    ('Injury Update: Player X Out of Tournament', 'Unfortunately, Player X has been ruled out of the tournament due to a knee injury.', 3, 2);
